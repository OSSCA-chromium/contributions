...
자세한 내용은 [Gerrit Guide](https://chromium.googlesource.com/chromium/src/+/main/docs/gerrit_guide.md)를
참고하세요.
...
전체 체크리스트는 [Commit Checklist](https://chromium.googlesource.com/chromium/src/+/main/docs/commit_checklist.md)를
참고하세요.
