...
접근 권한이 있다면 지금이 변경을 [자동 테스트](#자동-테스트-실행하기)에 돌리기 좋은 시점입니다.
...
[code-reviews-owners]: https://chromium.googlesource.com/chromium/src/+/main/docs/code_reviews.md#OWNERS-files
[code-reviews]: https://chromium.googlesource.com/chromium/src/+/main/docs/code_reviews.md
[commit-checklist]: https://chromium.googlesource.com/chromium/src/+/main/docs/commit_checklist.md
[commit-queue]: https://chromium.googlesource.com/chromium/src/+/main/docs/infra/cq.md
...
[watchlist-doc]: https://chromium.googlesource.com/chromium/src/+/main/docs/infra/watchlists.md
