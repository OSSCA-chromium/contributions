...
* 각 마일스톤의 주요 개발 기간(4주)은 위에 묘사되어 있지 않지만, 아래 [채널 수명 주기](#channel-lifecycle)에서는 볼 수 있다.
...
원문: https://raw.githubusercontent.com/chromium/chromium/main/docs/process/release_cycle.md

## History

- 2026-07-07: Chromium `docs/process/release_cycle.md` 원문 전체를 한국어로 번역해 저장.
