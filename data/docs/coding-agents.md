...
[`//agents/prompts/README.md`]: https://chromium.googlesource.com/chromium/src/+/main/agents/prompts/README.md
...
[`//agents/extensions/README.md`]: https://chromium.googlesource.com/chromium/src/+/main/agents/extensions/README.md

### 스킬

특정 작업을 위한 온디맨드 전문 지식. [`//agents/skills/README.md`]를 참고한다.

[`//agents/skills/README.md`]: https://chromium.googlesource.com/chromium/src/+/main/agents/skills/README.md

### 사용자 정의 명령

이 항목들은 [`//.gemini/commands`]에 추가한다.

[`//.gemini/commands`]: https://chromium.googlesource.com/chromium/src/+/main/.gemini/commands/README.md
