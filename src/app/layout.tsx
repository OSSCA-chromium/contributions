...
export default function RootLayout({
  ...
  return (
    // The theme bootstrap may add the dark class before React hydrates.
      ...
      >
        <header className="sticky top-0 z-20 border-b border-mline bg-background">
          <div
            ...
            style={{
              background:
                'linear-gradient(90deg, var(--c1) 0 25%, var(--c2) 25% 50%, var(--c3) 50% 75%, var(--c4) 75% 100%)',
            }}
            aria-hidden="true"
          />
          <div className="mx-auto flex min-h-14 max-w-[1060px] flex-wrap items-center gap-x-5 gap-y-2 px-5">
            <Link
              href="/"
